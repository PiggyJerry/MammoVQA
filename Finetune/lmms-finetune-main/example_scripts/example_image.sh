...
MODEL_ID=llava-1.6-vicuna-7b                                # model id; pick on by running `python supported_models.py`
# MODEL_ID=llava-interleave-qwen-7b  
TRAIN_DATA_PATH=/home/jiayi/MammoVQA/Benchmark/LLaVA-Mammo-train.json  # path to the training data json file
EVAL_DATA_PATH=/home/jiayi/MammoVQA/Benchmark/LLaVA-Mammo-eval.json    # path to the evaluation data json file (optional)
IMAGE_FOLDER=/home/jiayi/MammoVQA                   # path to the image root folder; if provided, the image paths in the json should be relative
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun $DISTRIBUTED_ARGS train.py \
    --model_id $MODEL_ID \
