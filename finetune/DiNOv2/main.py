...
from Mammo_VQA_dataset_DiNOv2 import MammoVQA_image,custom_collate_fn
...
if __name__ == "__main__":
    ...
    hypar['train_datapath'] = f'{parent_dir}/Benchmark/MammoVQA-Image-Train.json'
    ...
    hypar['model_name'] ="DiNOv2" ## model weights saving (or restoring) path
